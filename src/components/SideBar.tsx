...
import { Menu, X, LayoutDashboard, Users, Settings, Wrench } from 'lucide-react';
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-50">
      ...
      <div className="fixed top-0 z-40 flex w-full items-center border-b border-gray-200 bg-white p-4 shadow-sm md:hidden">
        ...
        <span className="ml-4 text-lg font-bold text-gray-800">Sistema</span>
      </div>
      ...
      >
        ...
        <div className="border-t border-gray-100 p-4">
          <button className="flex w-full items-center space-x-3 rounded-lg p-3 font-medium text-gray-600 transition-colors hover:bg-red-50 hover:text-red-600">
